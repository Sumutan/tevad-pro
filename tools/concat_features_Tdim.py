...
# 测试函数
folder_path = "/home/sh/TEVAD/save/tmp/UCF_9-5_9-1_finetune_DT0.25_SPa0.1/less3"  # 替换为实际的文件夹路径
feature_names = ["Normal_Videos307_x264","Normal_Videos308_x264","Normal_Videos633_x264"]
# feature_names = ["Normal_Videos633_x264"]
