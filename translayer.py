...
class Transformer(nn.Module):
    def __init__(self, dim, depth, heads,  mlp_ratio=4, dropout = 0.):
        dim_head=int(dim/heads)
        assert dim == dim_head*heads, ValueError("dim != dim_head*heads")
...
if __name__ == '__main__':
    ...
    # selfatt = Transformer(512, 2, 4, 128, 512, dropout = 0.5)
    selfatt = Transformer(512, 2, 4, 4, dropout=0.5)